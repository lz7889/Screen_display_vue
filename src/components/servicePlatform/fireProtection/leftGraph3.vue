<template>
  <div style="width: 100%; height: 100%">
    <div id="fireProtection-left3" style="width: 100%; height: 100%"></div>
...
<script>
import { fireProtectionLeft3 } from "@/data/dataService.js";
export default {
  components: {},
  data() {
    return {
      data: fireProtectionLeft3,
      chartDom: {},
      activeItem: "order",
    };
  },
  ...
  methods: {
    drawCharts() {
      this.chartDom = this.$echarts.init(
        document.getElementById("fireProtection-left3")
      );
      let data = this.data;
