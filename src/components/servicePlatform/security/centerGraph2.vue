<template>
  <div style="height: 100%; width: 100%">
    <div id="security-center2" style="width: 100%; height: 100%"></div>
    <div class="title-num">
...
<script>
import { securityCenter2 } from "@/data/dataService.js";

export default {
  components: {},
  data() {
    return {
      chartData: securityCenter2.chartData,
      chartDom: {},
      totalData: securityCenter2.totalData,
    };
  },
  watch: {
    chartData: {
  ...
  methods: {
    drawCharts() {
      this.chartDom = this.$echarts.init(
        document.getElementById("security-center2")
      );
